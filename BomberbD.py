...
logo=(green+"""     _____ _    _ _____ _______ _    _ _____ _      
 ...
 | (___ | |__| | | |    | |  | |__| | | | | |     
  \___ \|  __  | | |    | |  |  __  | | | | |     
  ____) | |  | |_| |_   | |  | |  | |_| |_| |____ 
 |_____/|_|  |_|_____|  |_|  |_|  |_|_____|______|
...
note=(cyan+"Note: I wont be responsible fo any illigal activites. >> This BomberbD tool is for use in Bangladesh only. Use our Global version for worldwide use.")
